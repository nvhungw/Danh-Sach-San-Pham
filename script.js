...
class App {
  ...
  findIndex(
    ...
    return this.products.findIndex(function (productItem) {// doi tuong product
  ...
  createProduct()
  {
    ...
    let productNew = new Product(idCreate, productNameEl.value, productPriceEl.value,imageLink) 
...
let imageLink = 'https://img.tgdd.vn/imgt/f_webp,fit_outside,quality_100/https://cdn.tgdd.vn/Products/Images/7077/282959/dong-ho-befit-b4-thumbnn-600x600.jpg';
